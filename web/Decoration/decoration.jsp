...
<head>
    ...
    <title>Decoration | Hana's Garden</title>
    <link rel="stylesheet" href="../nav-footer_styles.css" type="text/css">
    <link rel="stylesheet" href="decor_styles.css" type="text/css">
...
<body>
    ...
    <section>
        <article id="desc">
            ...
            <p>The precious moments shared with friends and families are what keeps the bonds strong between us.</br>
                These memories are kept forever and it should be made to be unforgetable.</br>
                Hana's Garden care about the memories that you share with your family and friends.</br> 
                Which is why we provide elegant and rather formal flowers for you and your loved ones.</br>
                We will assist you to create a memory so, the memory will never fade and stay forever with you.</br>
            </p>
            <img src="anniversary.png" alt="anniversary" width="400px" height="400px">
       
        </article>

        <article id="details">
            
        <img src="birthday.jpg" alt="birthday" width="400px" height="400px">
        <p><b>Details</b></br>
            Price : Varies around RM250 to RM350 depending on the area</br>
