...
<head>
    ...
    <title>Weddings | Hana's Garden</title>
    <link rel="stylesheet" href="../nav-footer_styles.css" type="text/css">
    <link rel="stylesheet" href="weddings_styles.css" type="text/css">
...
<body>
    ...
    <section>
        ...
        <article id="desc">
            <p>Weddings are a once in a lifetime event where couples are bonded for the rest of thier lifes.</br>
                Wedding tradition and custom varies between culture, religion, country and more.</br>
                But no matter the difference between us, the presence of flowers is a must.</br></br>
                So Hana's Garden will make sure that your special day will be memorable.</br>
                Whether it's simplicity that you are after, or the most elaborate of arrangements,</br>
                Hana's Garden is sure to satisfy your needs.</p>
            <img src="wedding 2.jfif" alt="wedding 1" width="400px" height="400px">
        </article>
    <form method="post" action="../reserveJSP.jsp" >
        <article id="details">
            
            <img src="wedding3.jfif" alt="wedding 2" width="400px" height="400px">
            <p><b>Details</b></br>
            Price : Varies around RM4000 to RM6000 depending on the area</br>
            Range : Penang Island and Butterworth</br>
            First come first serve!</br>
            Services can be done 4 times a week with prior notice!</br>
            Kindly provide your correct email address / phone number so that it would simplify our work to follow up on the situation.</br>
            Please <a href="../Contact Us/contact us.html">contact us</a> to make bookings for the service at least a week before the day of event.</p>
                <%
                    session.setAttribute("serviceID","SW22-0001-3910");
                %>
